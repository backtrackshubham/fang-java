...
//        int[] arr = {2, 4, 3, 5, 6, 4};
//        List<ListNode> collect = Arrays.stream(arr).mapToObj((value) -> Solution.getNode.apply(value)).collect(Collectors.toList());
...
//        System.out.println(Solution.addTwoNumbers(l1, l4));
//    }
//}
//
//class ListNode {
